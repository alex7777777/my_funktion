...
my_pattern_df <- function(data_seq, 
  ...
  # Counting events:
  # events_big <- (sort(table(seq), decreasing = T))
  ...
  # print(paste0("Support of 3er events: ", SUPPORT3er))
  # print(paste0("Number of 3er events: " , TOP_n_3er))
  ...
  # print(paste0("Check: Number of 3er events: " , length(events_small)))
  ...
  df_to_smartdata <- cbind(data_seq_head, data_frequenz_1, data_frequenz_2, data_frequenz_3)
